...
if ($ext == 'jpg' OR $ext == 'png' OR $ext == 'png' OR $ext == 'jpeg' ) {
  ...
  // Upload efetuado com sucesso, exibe uma mensagem e um link para o arquivo
  	   if(isset($_POST['destaque'])){
			   ...
			   $dados=array('conteudo'=>$_POST['conteudo'],'titulo'=>$_POST['titulo'],'arquivo'=>$irBanco,'id_categoria'=>$_POST['select'],'destaque'=>$_POST['destaque']);
         
		   }
	   else{
		   			   $dados=array('conteudo'=>$_POST['conteudo'],'titulo'=>$_POST['titulo'],'arquivo'=>$irBanco,'id_categoria'=>$_POST['select']);
  ...
  echo "Não foi possível enviar o arquivo, tente novamente";
	...
	echo "<script>alert('Permitido imagens do tipo : jpg,jpeg,png e gif');</script>";
				   ...
				   try{
					   $dados=array('conteudo'=>$_POST['conteudo'],'titulo'=>$_POST['titulo'],'arquivo'=>'','id_categoria'=>$_POST['select']);
            Postagem::insert($dados);
